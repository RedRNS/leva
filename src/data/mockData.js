export const mockTools = [
  ...
  { id: 2, name: "GitHub Copilot", category: "Coding", iconKey: "code", url: "github.com/copilot", desc: "Asisten koding AI dari GitHub yang membantu autocomplete dan debug kode secara real-time.", detailDesc: "Produktif untuk pairing saat ngerjain praktikum atau project coding. Performa terbaik tersedia lewat langganan berbayar.", pricingType: "paid", rating: 4.9, jurusan: ["Teknik Informatika", "Sistem Informasi"] },
  ...
  { id: 4, name: "Julius AI", category: "Data", iconKey: "bar-chart", url: "julius.ai", desc: "Analisis data dan buat visualisasi hanya dengan upload spreadsheet dan bertanya dalam bahasa natural.", detailDesc: "Praktis untuk mahasiswa yang butuh insight data cepat tanpa coding panjang. Paket gratis ada, kapasitas lebih besar tersedia di paket berbayar.", pricingType: "freemium", rating: 4.5, jurusan: ["Teknik Informatika", "Manajemen", "Akuntansi", "Administrasi Bisnis", "Matematika", "Sosiologi"] },
  ...
  { id: 8, name: "Codeium", category: "Coding", iconKey: "code", url: "codeium.com", desc: "Alternatif Copilot gratis dengan kemampuan koding AI multi-bahasa pemrograman.", detailDesc: "Pilihan ekonomis untuk auto-complete dan assist coding harian. Cocok saat butuh opsi non-paywall.", pricingType: "free", rating: 4.4, jurusan: ["Teknik Informatika", "Sistem Informasi"] },
  { id: 9, name: "Elicit", category: "Academic", iconKey: "book", url: "elicit.com", desc: "Otomatiskan literature review dan ekstraksi data dari paper ilmiah.", detailDesc: "Meringkas dan mengekstrak temuan paper dengan cepat untuk draft tinjauan pustaka. Tersedia paket gratis dengan batas penggunaan.", pricingType: "freemium", rating: 4.3, jurusan: ["Semua"] },
];
